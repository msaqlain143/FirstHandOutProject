            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mr-auto align-items-center">
                    <li class="nav-item active">
                        <a class="nav-link mr-5 text-white" style="font-size: 23px" href="{{ route('web-home') }}">Home</a>
                    </li>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-sm-8 mt-4">
                ...
                <div class="card p-4">
                    <p>Name : <b> Computer Science</b></p>
                    <p>Description: <b>Computer Science is the study of computers and computational systems. Unlike electrical and computer engineers, computer scientists deal mostly with software and software systems; this includes their theory, design, development, and application.
                    </b></p>
                    <p>Duration :<b> 4-months</b></p>
                    <img src="/images/ComputerScience.jpeg" alt="Product Image" class="rounded  mt-2 mx-auto d-block" width="50%">
                </div>
            </div>
        </div>
    </div>
