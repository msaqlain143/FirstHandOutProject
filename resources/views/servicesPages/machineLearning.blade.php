    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-success">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link text-white text-white" style="font-size: 23px" href="{{ route('login') }}">Login</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-sm-8 mt-4">
                ...
                <h2 class="text-center">Details Of Course :</h2>
                <div class="card p-4">
                    <p>Name : <b> Machine Learning </b></p>
                    <p>Description: <b>What is machine learning? Machine learning is a branch of artificial intelligence (AI) and computer science which focuses on the use of data and algorithms to imitate the way that humans learn, gradually improving its accuracy. IBM has a rich history with machine learning.
                    </b></p>
                    <p>Duration :<b> 6-months</b></p>
                    <img src="/images/machinelearning.jpeg" alt="Machine Learning " class="rounded mt-2 mx-auto d-block" width="50%">
                </div>
            </div>
        </div>
    </div>
