...
<div class="container">
    ...
    <h1 class="text-center text-primary">New Faculty Record </h1>
                ...
                <form action="{{route('login')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="address" id=""
                            aria-describedby="helpId" placeholder="Enter Yuor Address">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="desigination" id=""
                            aria-describedby="helpId" placeholder=" Upload Your Desigination ">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="file" id="" class="form-control"
                            value="{{ old('file') }}" aria-describedby="helpId">
                        @if ($errors->has('file'))
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="experience" id=""
                            aria-describedby="helpId" placeholder=" Upload Your Experience ">
